...
const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/signup",payload)
return response
}
...
export async function login(context) {
    ...
    const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/get-token", payload)
...
export async function getUserInfo(token) {
  ...
  const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/", payload)
...
export async function updateUser(token, context) {
  ...
  const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/update", payload)
...
export async function deleteUser(token) {
  ...
  const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/delete", payload)
...
export async function changePassword(token, context) { // context = {old_password, new_password1, new_password2}
  ...
  try{
    ...
    const response = await basicFetch("http://3.17.187.145:8000/encouragement/accounts/password_change", payload)
...
export async function resetPassword(email) {
  try {
      const response = await fetch("http://3.17.187.145:8000/encouragement/accounts/password_reset", {
          method: "POST",
          headers: {
              "Content-Type": "application/json"
          },
...
export async function resetPasswordConfirm(uidb64, token, password, confirmPassword) {
  ...
  try {
      const response = await fetch(`http://3.17.187.145:8000/encouragement/accounts/reset/${uidb64}/${token}/`, payload);
